...
var yourOwnAndPurchased = function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
    var user, products, ownProductsFilesId, orders, purchasedProductsFilesId;
    var req = _b.req;
    return __generator(this, function (_c) {
        switch (_c.label) {
            ...
            case 1:
                ...
                ownProductsFilesId = products.map(function (prod) { return prod.product_files; }).flat();
                return [4 /*yield*/, req.payload.find({
                        collection: "orders",
                        depth: 2,
                        where: {
            ...
            case 2:
                orders = (_c.sent()).docs;
                purchasedProductsFilesId = orders
                    .map(function (order) {
                    return order.products.map(function (product) {
                        if (typeof product === "string") {
                            return req.payload.logger.error("search depth sufficient to find purchased file IDs");
                        }
                ...
                return [2 /*return*/, {
                        id: {
                            in: __spreadArray(__spreadArray([], ownProductsFilesId, true), purchasedProductsFilesId, true),
                        },
                    }];
        }
    });
