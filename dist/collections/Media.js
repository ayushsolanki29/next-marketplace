...
var isAdminOrHasAcccessToImages = function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, isAdminOrHasAcccessToImages()({ req: req })];
                    case 1: return [2 /*return*/, _c.sent()];
                }
            });
        }); },
        delete: isAdminOrHasAcccessToImages(),
        update: isAdminOrHasAcccessToImages(),
    },
    admin: {
        hidden: function (_a) {
            var user = _a.user;
